    ...
    App.initHelpers(['datepicker', 'select2']);
        ...
        $('.sendForm').on('click', function(){
          ...
          $.post('/admin/citas/checkDisp',data, function(resp) {
            if (resp == 'bloqueo'){
              window.show_notif('error', 'Horario bloqueado para el esthetic terapeuta');
              return;
            }
            if (resp>1){
        ...
        $('.equipment').click(function (e) {
          ...
          var data = {
            ...
            var posting = $.post( '/admin/toggle/estheticG', data ).done(function( data ) {
                if (data == 'OK'){
