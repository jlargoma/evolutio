...
<button type="button" class="btn btn-success addDate" data-date="{{time()}}" data-time="8">
    ...
    <a href="/admin/citas-fisioterapia-getafe/" class="btn btn-success" style="float: right; margin-left: 3px;">Calendario</a>
	...
	<div class="row">
            <div class="col-md-12">
                ...
                <div class="col-xs-2 mx-1em">
                 ...
                 @include('fisioterapiaGetafe.tabla')
            </div>
	</div>
</div>
...
$('.coachsFilter').on('click','li',function(event){
    ...
    location.assign("/admin/citas-fisioterapia-getafe/listado/"+coach+"/"+type);
});
