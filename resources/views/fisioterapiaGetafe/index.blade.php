...
@section('headerTitle') Citas Fisioterapia Getafe @endsection
@section('headerButtoms')
<button type="button" class="btn btn-success addDate" data-date="{{time()}}" data-time="8">
    <i class="fa fa-plus-circle"></i></button>
    <a href="/admin/citas-fisioterapia-getafe/listado/" class="btn btn-success" style="float: right; margin-left: 3px;">Listado</a>
    <a href="/admin/citas-fisioterapia-getafe-week/" class="btn btn-success" style="float: right; margin-left: 3px;">Semana</a>
...
<div class="content content-full bg-white">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="text-center">
                      <a href="/admin/citas-fisioterapia" class="btn btn-lg btn-dark">VILLAVICIOSA</a>
                      <a href="/admin/citas-fisioterapia-getafe" class="btn btn-lg btn-success">GETAFE</a>
                      <hr>
                    </div>
                  </div>
                </div>
    ...
    @include('fisioterapiaGetafe.modals')
@endsection
...
<script src="{{assetv('/js/calendar/fisioGetafe.js')}}"></script>
