        ...
        <div class="col-md-12 col-xs-12 push-20">
            ...
            <input type="hidden" name="id" value="{{ $date->user->id }}">
                ...
                <div class="col-md-3 col-md-offset-2  push-20">
                    <div class="form-material">
                        <input class="form-control" type="text" id="rate" name="rate" required maxlength="9" value="<?php echo $date->user->rate->id ?>">
                ...
                <div class="col-md-12  push-20">
                   <div class="form-material">
                       <textarea class="form-control" type="text" id="comment" name="comment" required maxlength="500" value="" rows="9"></textarea>
