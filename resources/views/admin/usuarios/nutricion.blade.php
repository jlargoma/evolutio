	...
	<div class="row ">
    	...
    	<div class="col-xs-12">
    		<h2 class="text-center font-s36 font-w300">
    			<?php echo strtoupper('Listado de Citas Nutricion') ?>
	                ...
	                <table class="table table-striped js-dataTable-full-clients table-header-bg dataTable no-footer">
	                    ...
	                    <tbody>
							<?php foreach ($visitas as $visita): ?>
								<tr> 
									<td class="text-center"><a class="btn-user" data-toggle="modal" data-target="#modal-popout-inform" data-idUser="<?php echo $visita->user->id; ?>" type="button" data-toggle="tooltip" title="" data-type="user" data-original-title="Editar user"  style="cursor: pointer"><b><?php echo $visita->user->name; ?></b></a></td>
									<td class="text-center"><?php echo $visita->user->telefono ?></td>
									<td class="text-center">
										<div class="btn btn-md btn-success date-nutri" type="button" data-toggle="modal" data-target="#modal-date" style="margin-right: 20px;float: right;" data-title="NUTRI" data-idUser="<?php echo $visita->user->id; ?>" >
											<i class="fa fa-apple" aria-hidden="true"></i>
									
										</div>
									</td>
									<?php for ($i=1; $i < 13; $i++):?>
									<td><?php $citas = \App\Dates::where('id_user' , $visita->user->id)->where('id_type_rate',5)->whereMonth('date','=' , $i)->orderBy('date','ASC')->get(); ?>
